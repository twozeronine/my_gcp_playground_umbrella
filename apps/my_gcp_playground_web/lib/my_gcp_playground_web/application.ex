defmodule MyGcpPlaygroundWeb.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # Start a worker by calling: MyGcpPlaygroundWeb.Worker.start_link(arg)
      # {MyGcpPlaygroundWeb.Worker, arg}
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: MyGcpPlaygroundWeb.Supervisor]
